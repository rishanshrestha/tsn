...
export function Team() {
  return (
    <section id="team" className="bg-surface section-py border-t border-rule/20">
      <div className="content-max">
        {/* Header */}
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <AnimatedSection>
            <h2 className="section-h2 text-void">The People <br /> Behind TSN.</h2>
          </AnimatedSection>
          <AnimatedSection delay={0.1}>
            <p className="font-body text-[15px] text-lead leading-relaxed max-w-sm text-right">
              A collective of founders, investors, and community
              leaders dedicated to the Nepali startup ecosystem.
            </p>
          </AnimatedSection>
        </div>
        ...
        >
          {TEAM.map((member, i) => (
            <TiltCard key={i} className="group border-r border-b border-rule/20 bg-surface">
              <motion.div
              ...
              >
                <div className="space-y-8">
                  <div className="w-16 h-16 rounded-full bg-surface2 flex items-center justify-center transition-colors group-hover:bg-electric">
